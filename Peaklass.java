    ...
    public static void main(String[] args) throws Exception {
        ...
        if (valik.toLowerCase().equals("treening")) {
            ...
            for (int e = 0; e < Harjutused.size(); e++){
                System.out.print(Harjutused.get(e));
            ...
            Lugeja.loeFaili("C:\\Users\\Siim\\IdeaProjects\\ProgeProjekt\\src\\" + HarjutusteList.getNimi() + "-" + alguskuupäev.substring(0, 10).replace("/", "."), HarjutusteList);
        }
    }
}
